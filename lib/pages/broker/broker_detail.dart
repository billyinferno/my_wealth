                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(formatIntWithNull(
                              value: _transactionList.brokerSummaryVolume
                            )),
                          ],
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(formatCurrencyWithNull(
                              amount: _transactionList.brokerSummaryValue
                            )),
                          ],
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              formatIntWithNull(
                                value: _transactionList.brokerSummaryFrequency,
                                checkThousand: false,
                                showDecimal: false
                              )
                            ),
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text(
                                          (
                                            ...
                                            formatIntWithNull(
                                              value: _transactionList.brokerSummaryCodeList[index].brokerSummaryLot,
                                              checkThousand: false,
                                              showDecimal: true
                                            ) :
                                            formatIntWithNull(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text(
                                          formatCurrencyWithNull(
                                            amount: _transactionList.brokerSummaryCodeList[index].brokerSummaryValue,
                                            checkThousand: false,
                                            showDecimal: true,
                                          ),
                                          style: const TextStyle(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text(
                                          formatIntWithNull(
                                            value: _transactionList.brokerSummaryCodeList[index].brokerSummaryLastPrice,
                                            checkThousand: false,
                                            showDecimal: false
                                          ),
                                          style: const TextStyle(
  ...
  List<Widget> _generateCombineRows(Map<DateTime, BrokerSummaryTxnCombineModel> data) {
    ...
    data.forEach((key, value) {
      result.add(_generateRow(
        ...
        formatIntWithNull(
          value: value.brokerSummaryBuyLot,
          checkThousand: false,
          showDecimal: false,
        ),
        formatCurrencyWithNull(
          amount: value.brokerSummaryBuyValue,
          checkThousand: true,
          showDecimal: true,
        ),
        formatCurrencyWithNull(
          amount: value.brokerSummaryBuyAverage,
          checkThousand: false,
          showDecimal: false
        ),
        formatIntWithNull(
          value: value.brokerSummarySellLot,
          checkThousand: false,
          showDecimal: false
        ),
        formatCurrencyWithNull(
          amount: value.brokerSummarySellValue,
          checkThousand: true,
          showDecimal: true,
        ),
        formatCurrencyWithNull(
          amount: value.brokerSummarySellAverage,
          checkThousand: false,
          showDecimal: false,
        )
      ));
  ...
  Widget _generateAverage(Map<DateTime, BrokerSummaryTxnCombineModel> data) {
    ...
    if(data.isEmpty) {
      ...
      return _generateRow(
        ...
        formatCurrencyWithNull(
          amount: totalBuyValue,
          checkThousand: true,
          showDecimal: true,
        ),
        formatCurrencyWithNull(
          amount: totalBuyAverage,
          checkThousand: false,
          showDecimal: false,
        ),
        formatIntWithNull(
