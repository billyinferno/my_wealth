...
class LineChartPainter extends CustomPainter {
  ...
  void _drawGuideLine({
    ...
    _drawText(
        ...
        width: 60,
        text: formatCurrency(amount: max),
        left: 0,
        top: -5,
        minHeight: 10,
        maxHeight: graphRect.height,
    ...
    if (isShowLegend) {
      ...
      _drawText(
        ...
        width: 60,
        text: formatCurrency(amount: avgPrice),
        left: 0,
        top: -10,
        minHeight: 10,
        maxHeight: graphRect.height,
      ...
      _drawText(
        ...
        position: Offset(graphRect.right, graphRect.bottom - yD),
        width: 60,
        text: formatCurrency(amount: ma5),
        left: 0,
        top: -10,
        minHeight: 10,
        maxHeight: graphRect.height,
      ...
      _drawText(
        ...
        position: Offset(graphRect.right, graphRect.bottom - yD),
        width: 60,
        text: formatCurrency(amount: ma8),
        left: 0,
        top: -10,
        minHeight: 10,
        maxHeight: graphRect.height,
      ...
      _drawText(
        ...
        position: Offset(graphRect.right, graphRect.bottom - yD),
        width: 60,
        text: formatCurrency(amount: ma13),
        left: 0,
        top: -10,
        minHeight: 10,
        maxHeight: graphRect.height,
